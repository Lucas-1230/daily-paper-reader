...
<p>精读：《FUSE: An Evaluating Framework for Dangerous Capabilities of LLMs》（9.0/10）</p>
<p>速读：《Validity-Aware Jailbreak Evaluation for Large Language Models》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="FUSE: An Evaluating Framework for Dangerous Capabilities of LLMs">FUSE: An Evaluating Framework for Dangerous Capabilities of LLMs</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Validity-Aware Jailbreak Evaluation for Large Language Models">Validity-Aware Jailbreak Evaluation for Large Language Models</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">ca <strong>1</strong></span></div>
</section>
</div>
