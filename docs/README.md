...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-25 22:24:24 UTC<br>状态：成功</p>
</section>
...
<p>精读：《Where Cyber Agents Struggle: Bottleneck Analysis of Multi-Stage LLM Agents》（10.0/10）, 《Codetta: High-Capacity, Keyless, and Undetectable Multi-Agent Collusion》（8.0/10）</p>
<p>速读：《Hard Stop: Kernel-Level Preemption and Containment for Rogue Agentic Execution》（7.0/10）, 《Rethinking Multi-Agent Collaboration: When More Is Less》（6.0/10）, 《Calibrated Decision Models for Autonomous Penetration-Testing Harnesses: JEV and Laya as System One Decision Layers for LLM-Driven Pentest Agents》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Where Cyber Agents Struggle: Bottleneck Analysis of Multi-Stage LLM Agents">Where Cyber Agents Struggle: Bottleneck Analysis of Multi-Stage LLM Agents</span></li><li><span class="dpr-home-dashboard-paper-title" title="Codetta: High-Capacity, Keyless, and Undetectable Multi-Agent Collusion">Codetta: High-Capacity, Keyless, and Undetectable Multi-Agent Collusion</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Hard Stop: Kernel-Level Preemption and Containment for Rogue Agentic Execution">Hard Stop: Kernel-Level Preemption and Containment for Rogue Agentic Execution</span></li><li><span class="dpr-home-dashboard-paper-title" title="Rethinking Multi-Agent Collaboration: When More Is Less">Rethinking Multi-Agent Collaboration: When More Is Less</span></li><li><span class="dpr-home-dashboard-paper-title" title="Calibrated Decision Models for Autonomous Penetration-Testing Harnesses: JEV and Laya as System One Decision Layers for LLM-Driven Pentest Agents">Calibrated Decision Models for Autonomous Penetration-Testing Harnesses: JEV and Laya as System One Decision Layers for LLM-Driven Pentest Agents</span></li></ul>
  </div>
