...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-18 20:57:43 UTC<br>状态：成功</p>
</section>
...
<p>精读：《MazeRunner: Nonlinear Task and Clue Orchestration for LLM-driven Black-Box Automated Penetration Testing》（9.0/10）, 《SysEvolve: An AI-native, safe, autonomous adversarial attack-defense co-evolutionary system》（9.0/10）</p>
<p>速读：《Evaluating Agentic Learning Harness Capabilities Without Labels via the Scaling Hypothesis》（6.0/10）, 《Proving the Utility of Large Language Models in Cybersecurity Simulations: A Comprehensive Examination》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="MazeRunner: Nonlinear Task and Clue Orchestration for LLM-driven Black-Box Automated Penetration Testing">MazeRunner: Nonlinear Task and Clue Orchestration for LLM-driven Black-Box Automated Penetration Testing</span></li><li><span class="dpr-home-dashboard-paper-title" title="SysEvolve: An AI-native, safe, autonomous adversarial attack-defense co-evolutionary system">SysEvolve: An AI-native, safe, autonomous adversarial attack-defense co-evolutionary system</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Evaluating Agentic Learning Harness Capabilities Without Labels via the Scaling Hypothesis">Evaluating Agentic Learning Harness Capabilities Without Labels via the Scaling Hypothesis</span></li><li><span class="dpr-home-dashboard-paper-title" title="Proving the Utility of Large Language Models in Cybersecurity Simulations: A Comprehensive Examination">Proving the Utility of Large Language Models in Cybersecurity Simulations: A Comprehensive Examination</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">ca <strong>2</strong></span></div>
</section>
</div>
