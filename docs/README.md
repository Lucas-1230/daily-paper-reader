...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-25 21:07:46 UTC<br>状态：成功</p>
</section>
...
<p>精读：《Structural Inference in Undocumented Mobile Databases: A Reproducible Benchmark for Evaluating Agentic Reasoning in Digital Forensics》（8.0/10）</p>
<p>速读：《CyberFactory: Scaling Cyber Security Capabilities with Instances from the Wild》（7.0/10）, 《Towards Automated Cyber Threat Intelligence Elicitation in Underground Forums》（7.0/10）, 《OptiMAS: Automatically Optimize Multi-Agent System》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Structural Inference in Undocumented Mobile Databases: A Reproducible Benchmark for Evaluating Agentic Reasoning in Digital Forensics">Structural Inference in Undocumented Mobile Databases: A Reproducible Benchmark for Evaluating Agentic Reasoning in Digital Forensics</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="CyberFactory: Scaling Cyber Security Capabilities with Instances from the Wild">CyberFactory: Scaling Cyber Security Capabilities with Instances from the Wild</span></li><li><span class="dpr-home-dashboard-paper-title" title="Towards Automated Cyber Threat Intelligence Elicitation in Underground Forums">Towards Automated Cyber Threat Intelligence Elicitation in Underground Forums</span></li><li><span class="dpr-home-dashboard-paper-title" title="OptiMAS: Automatically Optimize Multi-Agent System">OptiMAS: Automatically Optimize Multi-Agent System</span></li></ul>
  </div>
