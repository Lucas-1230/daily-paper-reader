...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-14 22:18:06 UTC<br>状态：成功</p>
</section>
...
<p>今日精读一篇9.0高分论文，聚焦本地可部署小语言模型在网络安全CTF任务中的上下文分割评估。</p>
<p>最值得关注的是“小模型+安全CTF”这一务实方向，尤其是上下文分割对本地部署表现的影响。</p>
<p>建议普通读者从</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Evaluating Context Segmentation in Locally Deployable SLMs for Cybersecurity CTF Tasks">Evaluating Context Segmentation in Locally Deployable SLMs for Cybersecurity CTF Tasks</span></li></ul>
  </div>
