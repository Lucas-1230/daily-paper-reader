...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-07 22:41:27 UTC<br>状态：成功</p>
</section>
...
<p>速读：《Rethinking Indirect Prompt Injection as a Test-Time Search Problem》（7.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Rethinking Indirect Prompt Injection as a Test-Time Search Problem">Rethinking Indirect Prompt Injection as a Test-Time Search Problem</span></li></ul>
  </div>
