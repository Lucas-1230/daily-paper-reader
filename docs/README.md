...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-22 20:38:40 UTC<br>状态：成功</p>
</section>
...
<p>速读：《Beyond the Hype: Evaluating LLM Integration and Practical Limitations in Security Operation Centers》（7.0/10）, 《Breaking and Defending LLM-Powered Social Media Bot Detection Systems》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Beyond the Hype: Evaluating LLM Integration and Practical Limitations in Security Operation Centers">Beyond the Hype: Evaluating LLM Integration and Practical Limitations in Security Operation Centers</span></li><li><span class="dpr-home-dashboard-paper-title" title="Breaking and Defending LLM-Powered Social Media Bot Detection Systems">Breaking and Defending LLM-Powered Social Media Bot Detection Systems</span></li></ul>
  </div>
