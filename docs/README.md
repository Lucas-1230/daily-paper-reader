...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-13 21:37:27 UTC<br>状态：成功</p>
</section>
...
<p>速读：《Arbitrary Cipher Attacks Against Large Language Models Do Not Require Fine-Tuning》（7.0/10）, 《Towards Scalable and Cost-Efficient Vulnerability Detection: A Study on Automatic Query Generation》（7.0/10）, 《A Three-Tier Persona Vector for Controllable User Simulation in Agentic Evaluation》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Arbitrary Cipher Attacks Against Large Language Models Do Not Require Fine-Tuning">Arbitrary Cipher Attacks Against Large Language Models Do Not Require Fine-Tuning</span></li><li><span class="dpr-home-dashboard-paper-title" title="Towards Scalable and Cost-Efficient Vulnerability Detection: A Study on Automatic Query Generation">Towards Scalable and Cost-Efficient Vulnerability Detection: A Study on Automatic Query Generation</span></li><li><span class="dpr-home-dashboard-paper-title" title="A Three-Tier Persona Vector for Controllable User Simulation in Agentic Evaluation">A Three-Tier Persona Vector for Controllable User Simulation in Agentic Evaluation</span></li></ul>
  </div>
