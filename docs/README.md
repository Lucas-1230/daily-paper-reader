...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-19 21:26:57 UTC<br>状态：成功</p>
</section>
...
<p>精读：《A Cyber Range Evaluation of Autonomous Network Incident Response Agents》（8.0/10）</p>
<p>速读：《MiST: Mid-Training LLMs for Cybersecurity》（7.0/10）, 《Bridging the First-Hour Gap: Evaluating AI Reliability and Benchmarking Deficiencies in Cyber Incident Response for Law Enforcement》（6.0/10）, 《Contagion on the Trading Floor: How Adversarial Signals Spread in Multi-Agent Trading Systems》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="A Cyber Range Evaluation of Autonomous Network Incident Response Agents">A Cyber Range Evaluation of Autonomous Network Incident Response Agents</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="MiST: Mid-Training LLMs for Cybersecurity">MiST: Mid-Training LLMs for Cybersecurity</span></li><li><span class="dpr-home-dashboard-paper-title" title="Bridging the First-Hour Gap: Evaluating AI Reliability and Benchmarking Deficiencies in Cyber Incident Response for Law Enforcement">Bridging the First-Hour Gap: Evaluating AI Reliability and Benchmarking Deficiencies in Cyber Incident Response for Law Enforcement</span></li><li><span class="dpr-home-dashboard-paper-title" title="Contagion on the Trading Floor: How Adversarial Signals Spread in Multi-Agent Trading Systems">Contagion on the Trading Floor: How Adversarial Signals Spread in Multi-Agent Trading Systems</span></li></ul>
  </div>
