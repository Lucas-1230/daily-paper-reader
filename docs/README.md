...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-26 20:54:53 UTC<br>状态：成功</p>
</section>
...
<p>速读：《Large Language Models at the Intersection of Software Engineering and Software Security:An Evidence-Centered Structured Survey and Research Agenda》（7.0/10）, 《Aligned Alone, Misaligned Together: Forecasting Adversarial Capture in LLM Agent Populations》（7.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Large Language Models at the Intersection of Software Engineering and Software Security:An Evidence-Centered Structured Survey and Research Agenda">Large Language Models at the Intersection of Software Engineering and Software Security:An Evidence-Centered Structured Survey and Research Agenda</span></li><li><span class="dpr-home-dashboard-paper-title" title="Aligned Alone, Misaligned Together: Forecasting Adversarial Capture in LLM Agent Populations">Aligned Alone, Misaligned Together: Forecasting Adversarial Capture in LLM Agent Populations</span></li></ul>
  </div>
