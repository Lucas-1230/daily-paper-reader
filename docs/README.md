...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-16 21:59:20 UTC<br>状态：成功</p>
</section>
...
<p>精读：《Divide, Consult, Conquer: Capability Laundering Through Aligned LLMs》（9.0/10）</p>
<p>速读：《Automating Attack Graph Construction for Agentic Pentesting. Towards Neuro-Symbolic Vulnerability Hunting》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Divide, Consult, Conquer: Capability Laundering Through Aligned LLMs">Divide, Consult, Conquer: Capability Laundering Through Aligned LLMs</span></li></ul>
  </div>
