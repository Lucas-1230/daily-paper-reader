...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-28 04:03:14 UTC<br>状态：成功</p>
</section>
...
<p>今日共生成 3 篇推荐（精读 2 篇，速读 1 篇）</p>
<p>精读：《How Do LLM Agents Actually Get the Flag? Trace-Level Provenance for Agentic Offensive Security Evaluation》（9.0/10）, 《PLCBench: Can Autonomous LLM Agents Turn PLC Access into Sustained Physical Impact?》（9.0/10）</p>
<p>速读：《Toward a Threat Actor Profiling Taxonomy for Pre-Release Risk Management of Open-Weight Frontier Models》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="How Do LLM Agents Actually Get the Flag? Trace-Level Provenance for Agentic Offensive Security Evaluation">How Do LLM Agents Actually Get the Flag? Trace-Level Provenance for Agentic Offensive Security Evaluation</span></li><li><span class="dpr-home-dashboard-paper-title" title="PLCBench: Can Autonomous LLM Agents Turn PLC Access into Sustained Physical Impact?">PLCBench: Can Autonomous LLM Agents Turn PLC Access into Sustained Physical Impact?</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Toward a Threat Actor Profiling Taxonomy for Pre-Release Risk Management of Open-Weight Frontier Models">Toward a Threat Actor Profiling Taxonomy for Pre-Release Risk Management of Open-Weight Frontier Models</span></li></ul>
  </div>
