...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-20 20:49:06 UTC<br>状态：成功</p>
</section>
...
<p>速读：《CTIFoundry: An Agent-Native Corpus Scaffold for Cyber Threat Intelligence》（7.0/10）, 《ATLAS: Discovering Agent Strategies through LLM-Guided Abstraction and Automata Learning》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="CTIFoundry: An Agent-Native Corpus Scaffold for Cyber Threat Intelligence">CTIFoundry: An Agent-Native Corpus Scaffold for Cyber Threat Intelligence</span></li><li><span class="dpr-home-dashboard-paper-title" title="ATLAS: Discovering Agent Strategies through LLM-Guided Abstraction and Automata Learning">ATLAS: Discovering Agent Strategies through LLM-Guided Abstraction and Automata Learning</span></li></ul>
  </div>
