...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-10 21:58:20 UTC<br>状态：成功</p>
</section>
...
<p>精读：《Benchmarking LLMs for Threat Level Determination》（8.0/10）</p>
<p>速读：《AgentDrift: A Step-Labeled Benchmark of Injection-Hijacked LLM Agent Trajectories》（7.0/10）, 《Black-Box Red Teaming of Agentic AI: A Taxonomy-Driven Framework for Automated Risk Discovery》（7.0/10）, 《LLMs for Social Network Modeling: From Network Generation to Dynamic Processes》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Benchmarking LLMs for Threat Level Determination">Benchmarking LLMs for Threat Level Determination</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="AgentDrift: A Step-Labeled Benchmark of Injection-Hijacked LLM Agent Trajectories">AgentDrift: A Step-Labeled Benchmark of Injection-Hijacked LLM Agent Trajectories</span></li><li><span class="dpr-home-dashboard-paper-title" title="Black-Box Red Teaming of Agentic AI: A Taxonomy-Driven Framework for Automated Risk Discovery">Black-Box Red Teaming of Agentic AI: A Taxonomy-Driven Framework for Automated Risk Discovery</span></li><li><span class="dpr-home-dashboard-paper-title" title="LLMs for Social Network Modeling: From Network Generation to Dynamic Processes">LLMs for Social Network Modeling: From Network Generation to Dynamic Processes</span></li></ul>
  </div>
