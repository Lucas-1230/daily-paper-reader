...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-24 20:51:11 UTC<br>状态：成功</p>
</section>
...
<p>今日精读一篇高分论文，聚焦大模型在网络安全决策中“结构化但脆弱”的局限。</p>
<p>最值得关注：LLM 在结构化安全任务里看似可靠，实际在关键决策边界上容易失效。</p>
<p>建议普通读者把大模型当辅助而非裁决者，涉及安全决策时保留人工复核。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Structured but Fragile: On the Limits of LLMs in Cybersecurity Decision-Making">Structured but Fragile: On the Limits of LLMs in Cybersecurity Decision-Making</span></li></ul>
  </div>
